...
$pix=.35;
	...
	if (empty($_GET['fecharecibo'])) {echo "La fecha de recepcion no esta definido"; die;}
      ...
      $me->filtro='fecharecibo="'.$_GET['fecharecibo'].'"';
      $me->damemetadata();
	...
	$sql="	select vtr.*".
		 ...
		 "	where vtr.id_cveasunto=".$_GET['id_cveasunto']." and vtr.fecharecibo='".$_GET['fecharecibo']."' order by vtr.folio asc;	";
        $sql=$me->camposm["fuente"];
