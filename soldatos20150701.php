...
##   			$vas=$vas."<td > ";
	        $vas=$vas.($wltdf=="1" || $wltdf=="2" || $wltdf=="3" ? "" : "<td>");
	 		$vas = ($menuc["autocomplete"]=='1' ? $vas." <input type=text readonly=true class='leesinborder' name=au_".$wlnombre." ></input><br>\n" : $vas );
   			$vas=$vas."<select placeholder=\"prueba\" ".
...
##   	        echo "wlonchange=".$wlonchange." esfiltrode=".$esfiltrode;
			...
			$vas=$vas.($wlonblur!="" ? " onblur='".$wlonblur.";'" : "");  //20071109							
...
*/
	    	            ...
	    	            (($tipodedato == "timestamptz" || $tipodedato == "date") & $readonly!='t' ? " <input tabindex='-1' class='img' type=image id='fe_".$nombre."' name=fe_".$nombre." src='img/icon_datepicker.gif' onclick='muestrafecha(this);return false' title='Selecciona la fecha del calendario'></input>" : " " ).	    	            
                            (($espassword=="3") ? " <input tabindex='-1' size=20 class='captcha' readonly='on' type=text id='wl_".$nombre."_img' name=wl_".$nombre."_img title='Imagen de la captcha' ></input><input tabindex='-1' class='img' type=image id='wl_".$nombre."_bot' name=wl_".$nombre."_bot src='img/refresh.png' onclick='ReDrawCaptcha(this);return false' title='Refresca la imagen del captcha'></input>" : " " ).
...
//20071112     se incluyo los evento que se efectuar en el cliente        	                          
        ...
        {
     	echo "<td class='botones'> <input type=button class=button id='iBusca' src='img/action_search_20.gif' title='Buscat'  name=busca value=Busca ".
##        	  "onclick='abre_consulta(\"".$this->idmenu."\");return false'></input></td>\n";	        
        	"onclick='mantto_tabla(\"".$this->idmenu.
        	                          "\",\"".
