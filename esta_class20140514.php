...
class esta_class
{
   ...
   function piechart()
   {
	...
	echo "<body>\n";
        echo "<form>\n";
        echo "<h1>Estadistica de ".$this->campos_ce["titulo"]."<h1>";
   ...
   function generadatos()
   {
           ...
           if ($this->campos_ce["funcion"]=="barchartsort" || $this->campos_ce["funcion"]=="linechart")
           {
                 $sql="delete from estadisticas.estadisticas_datos where id_solicitud=".$this->argumentos["wl_id_solicitud"].";".
                      ...
                      " from (".
                      " select ".$this->campos_ce["groupby"]." as dia ".
           ...
           if ($this->campos_ce["funcion"]=="groupedbar" || $this->campos_ce["funcion"]=="stackedbar")
           {
                 $sql="delete from estadisticas.estadisticas_datos where id_solicitud=".$this->argumentos["wl_id_solicitud"].";".
                      ...
                      " from (".
                      " select ".$this->campos_ce["groupby"]." as dia ".
                      " ,".$this->campos_ce["agrupacion"]." as agrupacion ".
                      " ,".$this->campos_ce["quecalculo"]."  as cuantos ".
                      " from ".$this->campos_ce["nspname"].".".$this->campos_ce["tabla"]." as ge".
                      " where ".$this->campos_ce["filtro"]." between '".$this->campos_so["fecha_inicial"]."' and '".$this->campos_so["fecha_final"]."'".
                      " group by 1,2  ".
...
//      echo "paso parametros";
   ...
   function linechart()
   {
	...
	echo "</style>\n";
        echo "<form>\n";
        echo "<table>";
        echo "<tr><td colspan=2><h2>Estadistica de ".$this->campos_ce["titulos"]." ".$this->rango."</h2></td></tr>";
...
echo "    .range([height, 0]);\n";
        ...
        echo "var color = d3.scale.category20b();\n";
        echo "var wltotales = [];\n";
...
echo "      .attr(\"x\", function(d) { console.debug('d.name='+d.name); return x1(d.name); })\n";
echo "      .attr(\"y\", function(d) { wltotal=wltotal+d.value; x=ageNames.indexOf(d.name); wltotales[x]=(isNaN(wltotales[x]) ? 0 : wltotales[x])+d.value; console.debug('x='+x+' value='+d.value+' wltotal='+wltotales[x]); return y(d.value); })\n";
...
echo "      .style(\"fill\", function(d) { return color(d.name); });\n";
        ...
        echo "      .style(\"text-anchor\", \"start\")\n";
        echo "      .attr(\"y\", function(d) { console.debug('entro'); return y(d.y1); })\n";
        echo "      .attr(\"height\", function(d) { return y(d.y0) - y(d.y1); })\n";
        echo "      .attr(\"fill\",\"red\");\n";
