...
function Header()
{
	...
	$this->Cell(0,6,'REPORTE DE JUNTAS','B',1,'C',0);
	$this->Ln(3);
	$row=pg_fetch_array($sql_result,0);
	$this->SetFont('Arial','',5);
	$this->Cell(60,$wlalto1,'Fecha de cita:',0,0,'L',0);
	$this->Cell(60,$wlalto1,'Estatus:',0,1,'L',0);
	$this->SetFont('Arial','B',6);
	$this->Cell(60,4,$fecha_inicio.' - '.$fecha_fin,'LB',0,'C',0);
	$this->Cell(60,4,($estatus=='' ? 'SIN DEFINIR' : $row['descripcion']),'LB',0,'C',0);
