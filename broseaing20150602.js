		...
		if (wlmovto=='S')
			{
	           ...
	           window.close();
        		...
        		wlurl='xmlhttp.php';//20071105
        		passData='&opcion=mantto_tabla&idmenu='+wlmenu+'&movto='+wlmovto+buildQueryString('formpr')+"&wlllave="+escape(wlllave)+"&wlrenglon="+wlrenglon+"&wleventodespues="+wleventodespues+"&filtro="+escape(armaFiltro('formpr'));
	        	CargaXMLDoc();			
	        	return;
}
