...
function Header()
{
	...
	global $row;
	$this->SetTextColor(0);
	$this->Image('img/cdmx_02.png',30,14,0,0);
        $this->Ln(25);
        $enca='<p>VOL:<vb>'.$row['vol'].'</vb>                    <vb>'.$row['des_tipoprotocolo'].'</vb>                 FOJA:<vb>'.$row['escr_hojac'].'</vb></p>';
        $this->WriteTag(0,$wlalto1,$enca,0,'J');
        ##        <vb>'.$row['des_tipoprotocolo'].'</vb>           '.'FOJA <vb>'.$row['escr_hojac'].'</vb></p>';
        ##$this->WriteTag(60,$wlalto1,$enca,0,'L');
        ##$enca='vb>'.$row['des_tipoprotocolo'].'</vb>';
        ##$this->WriteTag(80,$wlalto1,$enca,0,'C');
##           '.'FOJA <vb>'.$row['escr_hojac'].'</vb></p>';
	...
	$this->WriteTag(0,$wlalto1,$wlpara,0,'J',0,0,19);
...
function Footer()
{
	...
	$this->SetFont('Courier','',12);
        ...
        $this->Multicell(80,$wlalto1,$firman,1,'C');
        $this->SetFont('Courier','',6);
        $this->MultiCell(70,3,$control,0,'J');
        $this->SetY(-60);
        $this->SetFont('Courier','B',10);
        $this->SetX(110);
...
$pdf = new PDF ();
$pdf->Fpdf('P','mm','Legal');
$pdf->SetStyle("p","courier","N",13);
$pdf->SetStyle("vb","courier","B",13);
$pdf->SetMargins(30,10,8);
