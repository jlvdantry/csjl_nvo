...
include('php-barcode.php');
	...
	$sql="	select *	".
                 " ,(select descripcion from agenda.tramites_tipo as ca where ca.id_tipotramite=agenda.tramites.id_tipotramite) as desasunto ".
                 " ,(select entrega from agenda.tramites_tipo as ca where ca.id_tipotramite=agenda.tramites.id_tipotramite) as entrega ".
		 "	from agenda.tramites 	".
...
$wlnombre=$row['entrega']=='t'? "Entrega de tramite ".$row["folio"] : $row['nombre']." ".$row['apepat']." ".$row['apemat'];
...
function Header()
{
	...
	$this->SetX(115);
	$this->SetFont('Arial','B',$wlsize1);
	$this->Cell($wllargo1,$wlalto1,'SOLICITANTE',0,1,'L',0);
	$this->SetX($wlsetx);
	$this->SetFont('Arial','B',$wlsize2);
	$this->Cell($wllargo2b,$wlalto2,$row['desasunto'],'BR',0,'C',1);
	$this->SetX(115);
	$this->SetFont('Arial','B',$wlsize2);
	$this->Cell($wllargo2b,$wlalto2,$wlnombre,'BR',1,'C',1);
	$this->SetX($wlsetx);
	$this->SetFont('Arial','B',$wlsize1);
...
function Footer()
{
	...
	//$this->SetX($wlsetx);
	//$this->SetFont('Arial','B',$wlsize2);
	//$this->Cell(120,$wlalto2,'FIRMA',0,0,'C',0);
	
	//$this->SetX($wlsetx2);
	//$this->SetFont('Arial','B',$wlsize1);
	//$this->Cell($wllargo1,$wlalto1,'PLAZO DE RESPUESTA:',0,1,'L',0);
	//$this->SetX($wlsetx2);
	//$this->SetFont('Arial','B',$wlsize2);
