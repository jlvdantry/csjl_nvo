<?php
    ...
    echo "  <link type='text/css' rel='StyleSheet' href='filas_rppcNuevo".$wltablero.".css' media='(min-width:1024px)' />\n";
    echo "  <link type='text/css' rel='StyleSheet' href='filas_rppcNuevo".$wltablero.".css' media='(max-width:481px)' />\n";
    echo "  <link type='text/css' rel='StyleSheet' href='filas_rppcNuevo".$wltablero.".css' media='(min-width:482px) and (max-width:1023px)' />\n";
    ...
    echo "</body>\n";
    echo "</html>";
    echo "<script src=\"filas_wsNuevo.js\"></script>\n";
