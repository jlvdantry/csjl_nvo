...
$pdf->SetLineWidth(0.2/$pix);
  ...
  $black    = '000000'; // color in hexa
	...
	$pdf->SetFont('Arial','B',9);
        ...
        $pdf->Image('img/Consejeria_02.jpg',$wlsetx/$pix+(35/$pix),$pdf->GetY(),60/$pix,0);
        $pdf->Image('img/AtencionCiudadana_02.jpg',$wlsetx/$pix+(100/$pix),$pdf->GetY(),60/$pix,0);
