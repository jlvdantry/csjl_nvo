 ...
 */
        function buscafolioint()
        {
          ...
          $sql=" select * from contra.v_gestioncontermino where folio like '%".$folio."%'".
               " and id_cveasunto=".
          ...
          { 
                 $msg="El trámite ".$folio." no existe";
                    ...
                    $reg->registra(2396,$tipotramite."|".$folio."|".$fecharecibo,1);//20070623
                    $reg=null;        //20070623
          ...
          if ($Row["estatus"]=="3")
          {
                 $msg="El trámite ".$folio." ya fue entregado";
                 $reg= new logmenus($this->connection); //20070623
                 $reg->registra(2396,$tipotramite."|".$folio."|".$fecharecibo,2);//20070623
                 $reg=null;        //20070623
                 echo "<_nada_>$msg</_nada_>";
                 return; 
          }
          ...
          {   
                 $msg="El trámite ".$folio." ya tiene una cita reservada";
                    $reg= new logmenus($this->connection); //20070623
                    $reg->registra(2396,$tipotramite."|".$folio."|".$fecharecibo,3);//20070623
                    $reg=null;        //20070623
                 echo "<_nada_>$msg</_nada_>"; 
                 return; }
          ...
          if ($Row["estatus"]!="5" && $Row["mensaje"]!="")
          {
                 ...
                 $msg=$Row["mensaje"];
                    $reg= new logmenus($this->connection); //20070623
                    $reg->registra(2396,$tipotramite."|".$folio."|".$fecharecibo."|".$msg,3);//20070623
                    $reg=null;        //20070623
                 echo "<_nada_>$msg</_nada_>";
                 return; }
          ...
          if ($Row["estatus"]!="5" && $Row["vencido"]=="0")
          {
                 ...
                 $reg= new logmenus($this->connection); //20070623
                 $reg->registra(2396,$tipotramite."|".$folio."|".$fecharecibo."|".$Row["fechatermino"],5);//20070623
                 $reg=null;        //20070623
                 echo "<_nada_>$msg</_nada_>";
                 return; }
          ...
          if ($Row["estatus"]!="5")
          { 
                 $msg="El trámite ".$folio." esta en proceso\n Desea reservar una cita?";
                 $reg= new logmenus($this->connection); //20070623
                 $reg->registra(2396,$tipotramite."|".$folio."|".$fecharecibo,4);//20070623
                 $reg=null;        //20070623
                 echo "<_nada_>$msg</_nada_>"; 
                 return; }

          $msg="Pase por respuesta a ventanilla 8 de Lunes a Viernes de 9:00 am a 13:30 o Desea reservar una cita?";
          $reg= new logmenus($this->connection); //20070623
          $reg->registra(2396,$tipotramite."|".$folio."|".$fecharecibo,6);//20070623
          $reg=null;        //20070623
          echo "<_nada_>$msg</_nada_>";
...
*/
	...
	function validapago()
	{
              ...
              {
                $Row = pg_fetch_array($sql_result, 0);
                echo "<error>La linea ya ocupada con el tramite ".$Row["folio"]." con fecha de recibo ".$Row["fecharecibo"]."</error>"; return;
              }
...
//           parent::subvista("impBoletaPDF.php","wlfolioconsecutivo=".$wlfolio."".htmlspecialchars("&")."relevante=".$relevante,600);
        ...
        {
           parent::subvista("impSolicitudPDF.php","wl_folioconsecutivo=".$this->argumentos["wl_folioconsecutivo"].htmlspecialchars("&")."id_cveasunto=".$this->argumentos["wl_id_cveasunto"].htmlspecialchars("&")."fecharecibo=".$this->argumentos["wl_fecharecibo"],600);
       }
