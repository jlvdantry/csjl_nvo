...
//	$this->cell(0,4,$titulo4,0,1,'L',0);
	...
	$this->SetFont('Arial','',9);
        $this->SetX(10);
	$this->Cell(15,$wlalto1,'Tramite:',0,0,'L',0);
	$this->Cell(55,$wlalto1,substr($row["id_cveasunto"],0,strpos($row["id_cveasunto"],"=")),'LB',0,'L',0);
	$this->Cell(35,$wlalto1,'Fecha de recepcion:',0,0,'L',0);
	$this->Cell(25,$wlalto1,$row["fecharecibo"],'LB',0,'C',0);
	$this->Cell(14,$wlalto1,'Folios:',0,0,'L',0);
      ...
      foreach ($me->camposmc as $index => $val)
      {
       if ($index!="fecharecibo" && $index!="id_cveasunto" && $index!="folioconsecutivo"  && $index!="" && $index!="fecha_alta" && $index!="usuario_alta"  && $index!="apepat" && $index!="apemat" && $index!="val_lc")
       {
          ...
          if ($val["fuente_campodep"]=="") {
             if ($val["size"]=="") { $tama=10; } else { $tama=$val["size"]; }
             //$this->Cell($tama,$wlalto1,$val["descripcion"],0,0,'L',0);
             array_push($lineatit,$val["descripcion"]);
          } else {
             if ($val["male"]=="") { $tama=20; } else { $tama=$val["male"]; }
             //$this->Cell($tama,$wlalto1,$val["descripcion"],0,0,'L',0);
             array_push($lineatit,$val["descripcion"]);
          }
          array_push($array,$tama);
       }
      }
	//$this->Cell(20,$wlalto1,'Entrega',0,0,'L',0);
        //array_push($lineatit,'Entrega');
	//$this->Cell(20,$wlalto1,'Recibo',0,1,'L',0);
        array_push($lineatit,'Recibio');
        //array_push($array,20);
        array_push($array,20);
