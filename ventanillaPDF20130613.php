...
function Header()
{
	...
	$this->SetFont('Arial','B',$wlsize1);
      ...
      {
       if ($index!="fecharecibo" && $index!="id_cveasunto" && $index!="estatus" && $index!="folioconsecutivo"  && $index!="" && $index!="fecha_alta" && $index!="usuario_alta"  && $index!="apepat" && $index!="apemat" && $index!="val_lc")
       {
          if ($index=="nombre") { $val["size"]="100"; }
...
//	$pdf->Cell(1,$wlalto2,'',0,0,0,0);
      ...
      foreach ($me->camposmc as $index => $val)
      {
       if ($index!="fecharecibo" && $index!="id_cveasunto" && $index!="estatus" && $index!="folioconsecutivo"  && $index!="" && $index!="fecha_alta" && $index!="usuario_alta"  && $index!="val_lc")
       {
          $pon=$row[$index];
          if ($index=="monto")
          ...
          if ($index=="apemat") {$pon=$wlnombre; $val["size"]="100"; }
