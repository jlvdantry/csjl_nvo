...
/*  20070707
    Funcion que la impresión se ve en patalla
*/        
function imprime()
{
try
...
{
//20070524		Actualizar el width y height en tiempo de diseño 	
...
function si_Select(wlselect,wlfiltro)
{
	try
	{
	  ...
	  {	
		...
		{
			alert('Primero debe teclear ó seleccionar el dato "'+document.getElementById("wlt_"+a[m]).value+'"');
			return false;
    	}	
	  }
  	}
