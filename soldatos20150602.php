...
##       		$vas=$vas."<td>".$descripcion. //20070214
##							($busqueda=='t' ? "*" : "" )."</td>\n"; //20070214			
...
*/
	    	            ...
	    	            (($tipodedato != "text") ? " ></input>" : " ></textarea>").
...
//      echo "entro en mantotab";	  print_r($this->menuc);
  ...
  function mantotab()
  {
     ...
     $sql_result = pg_exec($this->connection,$sql)
                   or die("Problemas al hacer sql mantotab ".pg_last_error($this->connection)." ".$sql );
     $num = pg_numrows($sql_result);
     if ( $num == 0 && 
     		 (   
         		 strpos($this->movto_mantto,"s")!==false 
