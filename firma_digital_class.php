...
class firma_digital_class extends xmlhttp_class
{
    ...
    {
          $num=0;
          $id=$this->argumentos["wl_id_escritura"];
          $sql=" select * from avitesta.v_escritura where id_escritura =".$id;
          $sql_result = @pg_exec($this->connection,$sql);
    ...
    function dame_xml()
    {
          ...
          $x->arr=array(
                       ...
                       "testador"=>array(
                          ...
                          "apellidoPaterno"=>$this->Row["ap_paterno"],
                          "apellidoMaterno"=>$this->Row["ap_materno"],
                          "nacionalidad"=>"mexicana",
                          "lugarDeNacimiento"=>$this->Row["lugar_nacimiento"],
                          "fechaDeNacimiento"=>$this->Row["fecha_nacimiento"],
                          "estadoCivil"=>$this->Row["nombre_estado_civil"],
                          "apellidoConyuge"=>$this->Row["ap_conyuge"],
                          "tambienConocidoComo"=>$this->Row["alias"]
                                         ),
                       "Instrumento"=>array(
                          "tipodeTestamento"=>$this->Row["nombre_tipo_testamento"],
                       ...
                       "Padres"=>array(
                          "nombrePadre"=>$this->Row["nombre_padre"],
                          "paternoPadre"=>$this->Row["ap_paterno_padre"],
                          "maternoPadre"=>$this->Row["ap_materno_padre"],
                          "nombreMadre"=>$this->Row["nombre_madre"],
                          "paternoMadre"=>$this->Row["ap_paterno_madre"],
                          "maternoMadre"=>$this->Row["ap_materno_madre"],
                          "apellidoConyugeMadre"=>$this->Row["ap_conyuge_madre"],
                                           ),
                       "Domicilio"=>array(
                          "calleYNumero"=>$this->Row["calle_num"],
                          "colonia"=>$this->Row["colonia"],
                          "delegacionMunicipio"=>$this->Row["tes_nombremunicipio"],
                          "entidad"=>$this->Row["nombre_estado"],
